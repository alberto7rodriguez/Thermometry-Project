...
B_ata_values = [
    1.2731, 1.2706, 1.2593, 1.2629, 1.2686,
    1.2593, 1.2531, 1.2529, 1.2500, 1.2502,
    1.2419, 1.2504, 1.2363, 1.2370, 1.2339,
    1.2410, 1.2250, 1.2189, 1.2306, 1.2218,
    1.2378, 1.2070, 1.2042, 1.2030, 1.1915,
    1.1996, 1.2072, 1.2078, 1.2056
]

J_ata_values = [
    0.0028, 0.0027, 0.0055, 0.0033, 0.0015,
    0.0028, 0.0033, 0.0029, 0.0029, 0.0026,
    0.0031, 0.0021, 0.0030, 0.0028, 0.0028,
    0.0022, 0.0030, 0.0032, 0.0024, 0.0027,
    0.0018, 0.0031, 0.0031, 0.0030, 0.0034,
    0.0029, 0.0025, 0.0024, 0.0024
]
B_ata = B_ata_values[N-2]
J_ata = J_ata_values[N-2]
